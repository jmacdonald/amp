...
pub fn accept<T: Terminal + Sync + Send>(app: &mut Application<T>) -> Result {
...
pub fn search<T: Terminal + Sync + Send>(app: &mut Application<T>) -> Result {
    match app.mode {
...
pub fn select_next<T: Terminal + Sync + Send>(app: &mut Application<T>) -> Result {
    match app.mode {
...
pub fn select_previous<T: Terminal + Sync + Send>(app: &mut Application<T>) -> Result {
    match app.mode {
...
pub fn enable_insert<T: Terminal + Sync + Send>(app: &mut Application<T>) -> Result {
    match app.mode {
...
pub fn disable_insert<T: Terminal + Sync + Send>(app: &mut Application<T>) -> Result {
    match app.mode {
...
pub fn pop_search_token<T: Terminal + Sync + Send>(app: &mut Application<T>) -> Result {
    match app.mode {
...
pub fn step_back<T: Terminal + Sync + Send>(app: &mut Application<T>) -> Result {
